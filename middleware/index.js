...
middlewareObj.checkMeditationOwnership = function(req,res,next){
                                            if(req.isAuthenticated()){
                                                Meditation.findById(req.params.id, function(err, foundMeditation){
                                                    if(err || !foundMeditation){
                                                        ...
                                                        if(foundMeditation.author.id.equals(req.user._id) || req.user.isAdmin){
                                                            req.meditation = foundMeditation;
                                                            next();
                                                        } else {
